...
TESTCASE1 = $(shell find $(TEST_PATH)/Lab1 -name "*.sy")
TESTCASE2 = $(shell find $(TEST_PATH)/Lab2 -name "*.sy")
TESTCASE3 = $(shell find $(TEST_PATH)/Lab3 -name "*.sy")

TESTCASE_NUM = $(words $(TESTCASE))
LLVM_IR = $(addsuffix _std.ll, $(basename $(TESTCASE)))
GCC_ASM = $(addsuffix _std.s, $(basename $(TESTCASE)))
OUTPUT_LAB1 = $(addsuffix .toks, $(basename $(TESTCASE1)))
OUTPUT_LAB2 = $(addsuffix .ast, $(basename $(TESTCASE2)))
OUTPUT_LAB3 = $(addsuffix .ll, $(basename $(TESTCASE3)))
...
.phony:all app run gdb testL testP testICG testTCG testir test clean clean-all clean-test clean-app llvmir gccasm
...
$(TEST_PATH)/Lab1/%.toks:$(TEST_PATH)/Lab1/%.sy
	@$(BINARY) $< -o $@ -t

$(TEST_PATH)/Lab2/%.ast:$(TEST_PATH)/Lab2/%.sy
	@$(BINARY) $< -o $@ -a

$(TEST_PATH)/Lab3/%.ll:$(TEST_PATH)/Lab3/%.sy
	@$(BINARY) $< -o $@ -i	
...
testL:app $(OUTPUT_LAB1)

testP:app $(OUTPUT_LAB2)

testICG:app $(OUTPUT_LAB3)

testTCG:app $(OUTPUT_LAB4)
